  ...
  return (
    ...
    >
        <div className="w-full">
            <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-green/30">
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        convert()
                ...
                >
                    <div className="w-full mb-1 text-blue-600">
                        <InputBox
                            label="From"
                            amount={amount}
                    ...
                    <div className="w-full mt-1 mb-4 text-blue-600">
                        <InputBox
                            label="To"
